...
interface TutorSignupFormErrors {
  firstName: string
  lastName: string
  email: string
  password: string
...
interface TutorSignupFormProps {
  ...
  handleChange: (
    key: keyof TutorSignupFormData
  ) => (event: React.ChangeEvent<HTMLInputElement>) => void
  handleBlur: (
    key: keyof TutorSignupFormData
  ) => (event: React.FocusEvent<HTMLInputElement>) => void
  data: TutorSignupFormData
  errors: TutorSignupFormErrors
}

const TutorSignupForm: FC<TutorSignupFormProps> = ({
  handleSubmit,
  handleChange,
  handleBlur,
  data,
